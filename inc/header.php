		...
		?>
				...
				<header id="header">
					...
					<div class="project-context hidden-xs">
						...
						<span id="project-selector" class="popover-trigger-element dropdown-toggle" data-toggle="dropdown">Тестирование <i class="fa fa-angle-down"></i></span>

						<!-- Suggestion: populate this list with fetch and push technique -->
						<ul class="dropdown-menu">
							<li>
								<a href="javascript:void(0);">Тестирование</a>
							</li>
							<li>
								<a href="javascript:void(0);">ЦК</a>
							</li>
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/login.php" title="Sign Out" data-action="userLogout" data-logout-msg="Вы можете улучшить вашу безопасность в дальнейшем после выхода закрыв все окна браузера."><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
						...
						<form action="#ajax/search.php" class="header-search pull-right">
							<input type="text" name="param" placeholder="Поиск..." id="search-fld">
							<button type="submit">
